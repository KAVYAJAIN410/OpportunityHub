...
export default function UserDetail() {
  ...
  return (
    <div className="bg-cover bg-center bg-no-repeat  bg-[url(../assests/assests/bg_website.png)]">
      ...
      {/* </main> */}
      <div className=" min-h-screen gap-4 p-4 md:p-8 lg:p-10 items-center align-middle ">
        <div className="col-span-1 sm:col-span-2 lg:col-span-2 flex items-center justify-center p-4 lg:p-8 bg-cover bg-center  rounded-3xl overflow-hidden">
          <div className="w-full max-w-md lg:max-w-lg">
            ...
            >
              <div className="flex flex-col gap-2 ">
                <label htmlFor="name" className="font-bold text-black text-md">
                  Full Name:
                </label>
                <input
                  ...
                  className={`border rounded-md text-2xl   text-black ${
                    errors.name
                      ? "border-red-500 focus:ring-red-300"
                      : "border-gray-300 focus:ring-blue-200"
                  } focus:outline-none focus:ring-2 text-xl p-2`}
                />
                {errors.name && (
              ...
              <div className="flex flex-col gap-2">
                <label htmlFor="email" className="font-bold text-black text-md">
                  Email:
                </label>
                <input
                  placeholder=" Email"
              ...
              <div className="flex flex-col gap-2">
                <label htmlFor="regNo" className="font-bold text-black text-md">
                  Registration Number:
                </label>
                <input
